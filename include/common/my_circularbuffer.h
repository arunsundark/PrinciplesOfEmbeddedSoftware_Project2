...
CB_status CB_buffer_add_item(CB_t source_buffer, uint8_t data)
/*
...
CB_status CB_buffer_remove_item(CB_t source_buffer, uint8_t data)
/*
...
*/
CB_status CB_is_full(CB_t source_buffer)
/*
...
CB_status CB_is_empty(CB_t source_buffer)
/*
